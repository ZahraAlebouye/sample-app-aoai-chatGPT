                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Fuel Transport Chatbot</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Please ask questions about Fuel Transport.</h2>
                            </Stack>
                        ) : (
